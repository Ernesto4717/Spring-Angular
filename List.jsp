		...
		<table class="table">
			...
			<tbody>
				...
				<tr data-ng-repeat="cart in cartList">
					<td><a
						href="<c:url value="/Cart/edit?cartId=${cart.id.id}&status="/>"><fmt:formatNumber
								pattern="000" value="${cart.id.id}" /></a></td>

					<td data-ng-bind=""></td>
					<td data-ng-bind="cart.cartDetails.shippingAmount"></td>
					<td data-ng-bind="cart.cartDetails.cartAmount"></td>
					<td data-ng-bind="cart.cartDetails.shipTo.name"></td>
					<td data-ng-bind="cart.cartDetails.status.description"></td>
					<td data-ng-bind="cart.audit.createDate"></td>
					<td data-ng-bind="cart.audit.updateDate"></td>
